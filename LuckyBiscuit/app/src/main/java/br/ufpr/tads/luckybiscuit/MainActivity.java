package br.ufpr.tads.luckybiscuit;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        luckOutput = findViewById(R.id.luckOutput);
    }

    public void newBiscuit(View view) {
        int num = new Random().nextInt(60);
        String luck = lucks[num];
        luckOutput.setText(luck);
    }
}